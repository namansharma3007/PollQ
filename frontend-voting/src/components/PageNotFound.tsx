...
const PageNotFound = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen w-full bg-gradient-to-r from-gray-900 to-gray-700 text-white relative overflow-hidden">
